...
public class T06TreeSetTest {
	public static void main(String[] args) {
		...
		// TreeSet에 저장된 데이터 중 특정한 값보다 작은 데이터를 찾아서 SortedSet으로 반환하는 메서드
		...
		// tailSet(기준값, 논리값) : 논리값이 false이면 '기준값'을 프함 시키지 않음
		SortedSet<String> ss2 = ts.tailSet("K");
		System.out.println("K 이후 데이터 : "+ ss2);
		System.out.println("K 이후 데이터(기준값 미포함) : "+ ts.tailSet("K",false));
		
		// subSet(기준값1, 기준값2) : 기준값 1~기준값2 사이의 값을 가져온다. ('기준값1'포함, '기준값2' 미포함)
