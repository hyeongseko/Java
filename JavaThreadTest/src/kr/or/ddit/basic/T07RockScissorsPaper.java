...
/*
	...
	결과예시)
		...
		결  과 : 당신이 이겼습니다.
*/
public class T07RockScissorsPaper {
...
class GameTimer extends Thread {
	...
	public void run() {
		for (int i = 5; i >= 1; i--) {
			if (T07RockScissorsPaper.inputCheck == true) {
				return;
			}
...
//			if (!inputData.equals("가위") && !inputData.equals("바위") && !inputData.equals("보")) {
//				continue;
//			} else {
//				break;
//			}
//		}
		...
		T07RockScissorsPaper.inputCheck = true; // 입력이 완료됨을 알려주는 변수값을 변경한다.
		T07RockScissorsPaper.man = inputData; // 입력값 설정
	}
}
